...
const SkillComponent = () => {
    ...
    return (
        <div className="mt-10">
            ...
            <div className="">
                <p className="my-5">
                    The following are the main technical skills I have mastered, including
                        ...
                        <div className="bg-white/10 group p-2 rounded" key={skills.id}>
                            <div className="group-hover:flex group-hover:items-center group-hover:gap-2">
                                <Image
                                    ...
                                    alt="Skill"
                                />
                                <p className="font-semibold hidden group-hover:block transition-all ease-in-out duration-500">
                                    {skills.nameSkill}
                                </p>
                            </div>
                        </div>
